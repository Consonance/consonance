...
/**
 * Test the main method in conjunction with a real workflow on AWS.
 *
 * @author briandoconnor@gmail.com
 */
public class SystemMainAwsIT {
    ...
    @Test
    public void testScheduleAndRunWdlOnAws() throws Exception{
        final WebClient webClient = SystemClientIT.getWebClient();
        ...
        // submitting a job via the web service
        main.runMain(new String[] { "run","--flavour","m4.large","--image-descriptor", wdlFile.getAbsolutePath() ,
        ...
        Coordinator.main(new String[] { "--config", "/Users/boconnor/.consonance/config" });
        ...
        //ContainerProvisionerThreads.main(new String[] { "--config", file2.getAbsolutePath(), "--flavour", "m4.large"});
        ContainerProvisionerThreads.main(new String[] { "--config", "/Users/boconnor/.consonance/config", "--flavour", "m4.large"});
        ...
        // TODO: need to check the status to make sure the job is successful
        // TODO: probably need to run reaper, also need to setup my configs properly
